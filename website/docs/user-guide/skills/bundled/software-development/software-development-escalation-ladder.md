---
title: "Escalation Ladder — Route delegate_task calls through a capability cascade"
sidebar_label: "Escalation Ladder"
...
Route delegate_task calls through a capability cascade.
...
| Path | `skills/software-development/escalation-ladder` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos |
| Tags | `delegation`, `routing`, `cost-optimization`, `model-selection`, `cascade` |
| Related skills | [`self-checking-harness`](../../bundled/software-development/software-development-self-checking-harness.md) |
