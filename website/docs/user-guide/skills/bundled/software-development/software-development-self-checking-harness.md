---
title: "Self Checking Harness — 5-gate validation protocol for subagents plus retrieval"
sidebar_label: "Self Checking Harness"
...
5-gate validation protocol for subagents plus retrieval.
...
| Path | `skills/software-development/self-checking-harness` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
