...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # CVE-2026-54283 (form-limit DoS); keep lazy-install in sync with pyproject [web]
    ...
    "tool.computer_use": (
        "mcp==1.26.0",
        "starlette==1.3.1",  # CVE-2026-54283 — keep in sync with pyproject [computer-use]
    ),
